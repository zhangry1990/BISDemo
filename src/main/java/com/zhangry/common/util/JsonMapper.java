        ...
        if(!this.checkSpecialType(fieldName)) {
            ...
            try {
                if(fieldName.contains(":")) {
                    ...
                    if(strOtherObjects.equals(JsonMapper.DATATYPE_DATETIME.DATE.name())) {
                        map1.applyPattern("yyyy-MM-dd");
                    } else if(strOtherObjects.equals(JsonMapper.DATATYPE_DATETIME.TIME.name())) {
                        map1.applyPattern("HH:mm:ss");
                    } else if(strOtherObjects.equals(JsonMapper.DATATYPE_DATETIME.CUSTOM.name())) {
                        map1 = this.sdf;
                    } else {
