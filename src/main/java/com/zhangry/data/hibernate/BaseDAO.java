...
public interface BaseDAO<T, Id extends Serializable> {
    ...
    List<T> find(Map<String, Object> var1, Sort... var2);

    List<T> findInCache(Map<String, Object> var1, Sort... var2);

    T findUnique(Map<String, Object> var1, Sort... var2);

    T findUniqueInCache(Map<String, Object> var1, Sort... var2);
