...
public class QueryParameter {
    ...
    public List<QueryParameter.Sort> getSortList() {
        return this.sortList;
    }

    public void setSortList(List<QueryParameter.Sort> sortList) {
        this.sortList = sortList;
    }

    public QueryParameter addSort(String fieldName, AscDesc ascOrDesc) {
        this.sortList.add(new QueryParameter.Sort(fieldName, ascOrDesc));
        return this;
    }
